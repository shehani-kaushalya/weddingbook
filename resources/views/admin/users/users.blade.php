        ...
        <div class="col-12">          
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form name="user_data" id="user_data" method="post" action="{{ route('users.edit') }}"  enctype="multipart/form-data">
                @csrf
                <!-- <form class="form-horizontal"  action="{{ config('app.asset_url') }}/admin/login" method="post"> -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="firstName" required value="{{ @$user_data['first_name'] }}" id="firstName" class="form-control" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lastName" class="col-sm-2 control-label">Last Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="lastName" required value="{{ @$user_data['last_name'] }}" id="lastName" class="form-control" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 control-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" id="email"  name="email" value="{{ @$user_data['email'] }}" required class="form-control" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="phone" class="col-sm-2 control-label">Phone</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="phone" name="phone" value="{{ @$user_data['phone'] }}" class="form-control" placeholder="Phone">
                                    </div>
                                </div>

                                <!-- Date dd/mm/yyyy -->
                                <div class="form-group row">
                                    <label for="dbo" class="col-sm-2 control-label">Date of Birth</label>

                                    <div class="input-group col-sm-10">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                        </div>
                                        <input type="text" required id="dbo" name="dbo" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask />
                                    </div>
                                    <!-- /.input group -->
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                 <div class="col-sm-12">
                                    ...
                                    {{-- <img id="profileImage" name="profileImage" class="profile-user-img img-fluid img-circle" style="Width:100px; height:100px;"
                                    ...
                                    @if(@$user_data->image != "") 
                                        ...
                                        src="{{config('amax.s3_bucket_url')}}/{{ @$user_data->image }}" style="width:100px; height:100px"
                                        alt="Profile picture" />
