        ...
        <div class="col-12">          
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form name="users_data" id="users_data" method="post" action="{{ route('users.edit') }}"  enctype="multipart/form-data">
                @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 control-label">Users Name</label>
                            <div class="col-sm-10">
