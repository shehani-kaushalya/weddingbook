    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Purchasing goods delivery</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active">Purchasing goods delivery</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($prs as $purchase)
                                <tr>
                                    <td>{{$purchase->id}}</td>
                                    <td>{{$purchase->invoice_no}}</td>
                                    <td>{{$purchase->reference}}</td>
                                    <td>{{$purchase->status == \App\Purchasing::PURCHASED ? 'Purchased' :
                                            ($purchase->status == \App\Purchasing::CANCELED ? 'Canceled' :
                                                ($purchase->status == \App\Purchasing::COMPLETED ? 'Completed' :
                                                    ($purchase->status == \App\Purchasing::PENDING ? 'Pending' :
                                                        ($purchase->status == \App\Purchasing::PROCESSING ? 'Processing' :
                                                            ($purchase->status == \App\Purchasing::PARTIAL_PURCHASED ? 'Partial Purchased' :
                                                                ($purchase->status == \App\Purchasing::DELIVERED ? 'Delivered to warehouse' : ''))))))}}</td>
                                    <td>{{$purchase->created_at}}</td>
                                    <td><a href="#" class="btn btn-sm btn-success" id="btn-purchasing-view" data-id="{{$purchase->id}}"><i class="fas fa-eye"></i> View Details</a> </td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                ...
                <div class="modal-body">
                    <div id="invoice">
                        ...
                        <div class="toolbar d-print-none">
                            <h2 class="text-left">Purchasing Receive</h2>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="update_purchase">Complete Purchase</button>
                    </div>
                </div>
            </div>
            <!-- /.modal-content -->
