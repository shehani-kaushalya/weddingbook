        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <a href="{{ route('pages.category.create') }}" class="btn btn-primary pull-right" style="text-align: right; float: right; margin-right: 20px; margin-top: 10px;" > Add category  </a>
            </div>
                ...
                @foreach($category_data as $category)
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                      <a href="{{ route('pages.category.edit', $category['id']) }}" class="btn btn-primary"> Edit </a>

                      @if(@$category['id'] != 1)
                        <button class="btn btn-danger" data-href="delete/{{ $category['id'] }}" data-toggle="modal" data-target="#category-delete">
                          Delete Category
                        </button>
                      @endif
